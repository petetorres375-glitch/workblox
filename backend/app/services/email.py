...
def _generate_pdf(subject, txt_content):
    ...
    pdf.set_xy(20, 8)
    pdf.cell(0, 5, "TORRES TECH REMOTE  |  WORKBLOX BUSINESS", ln=True)
    pdf.set_text_color(255, 255, 255)
    pdf.set_font("Helvetica", "B", 12)
    pdf.set_x(20)
    safe_subject = subject[:90].encode("latin-1", errors="replace").decode("latin-1")
    pdf.cell(0, 8, safe_subject, ln=True)
    ...
    while i < len(lines):
        ...
        if next_is_sep and line.strip():
            ...
            pdf.cell(0, 7, safe(line.strip()), ln=True)
    ...
    pdf.set_text_color(148, 163, 184)
    pdf.cell(0, 5, "Generated by Workblox Business  |  Torres Tech Remote", align="C")
